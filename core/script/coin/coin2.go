...
func (_Coin *CoinCaller) Eip712Domain(opts *bind.CallOpts) (struct {
	Fields            [1]byte
	Name              string
	Version           string
	ChainId           *big.Int
	...
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "eip712Domain")
...
//
// Solidity: function eip712Domain() view returns(bytes1 fields, string name, string version, uint256 chainId, address verifyingContract, bytes32 salt, uint256[] extensions)
func (_Coin *CoinSession) Eip712Domain() (struct {
	Fields            [1]byte
	Name              string
	Version           string
	ChainId           *big.Int
	...
	return _Coin.Contract.Eip712Domain(&_Coin.CallOpts)
}

// Eip712Domain is a free data retrieval call binding the contract method 0x84b0196e.
//
// Solidity: function eip712Domain() view returns(bytes1 fields, string name, string version, uint256 chainId, address verifyingContract, bytes32 salt, uint256[] extensions)
func (_Coin *CoinCallerSession) Eip712Domain() (struct {
	Fields            [1]byte
	Name              string
	Version           string
	ChainId           *big.Int
...
// GetDigest is a free data retrieval call binding the contract method 0xbba76a05.
//
// Solidity: function getDigest(address owner, address spender, uint256 value, uint256 deadline) view returns(bytes32)
func (_Coin *CoinCaller) GetDigest(opts *bind.CallOpts, owner common.Address, spender common.Address, value *big.Int, deadline *big.Int) ([32]byte, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "getDigest", owner, spender, value, deadline)
...
//
// Solidity: function getDigest(address owner, address spender, uint256 value, uint256 deadline) view returns(bytes32)
func (_Coin *CoinSession) GetDigest(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int) ([32]byte, error) {
	return _Coin.Contract.GetDigest(&_Coin.CallOpts, owner, spender, value, deadline)
}

// GetDigest is a free data retrieval call binding the contract method 0xbba76a05.
//
// Solidity: function getDigest(address owner, address spender, uint256 value, uint256 deadline) view returns(bytes32)
func (_Coin *CoinCallerSession) GetDigest(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int) ([32]byte, error) {
	return _Coin.Contract.GetDigest(&_Coin.CallOpts, owner, spender, value, deadline)
}

// MinterRole is a free data retrieval call binding the contract method 0xf084219e.
//
// Solidity: function minterRole() view returns(bytes32)
func (_Coin *CoinCaller) MinterRole(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "minterRole")
...
// RiskManager is a free data retrieval call binding the contract method 0x47842663.
//
// Solidity: function riskManager() view returns(address)
func (_Coin *CoinCaller) RiskManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "riskManager")
...
//
// Solidity: function riskManager() view returns(address)
func (_Coin *CoinSession) RiskManager() (common.Address, error) {
	return _Coin.Contract.RiskManager(&_Coin.CallOpts)
}

// RiskManager is a free data retrieval call binding the contract method 0x47842663.
//
// Solidity: function riskManager() view returns(address)
func (_Coin *CoinCallerSession) RiskManager() (common.Address, error) {
	return _Coin.Contract.RiskManager(&_Coin.CallOpts)
}
...
func (_Coin *CoinCaller) RoleManager(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "roleManager")
...
//
// Solidity: function roleManager() view returns(address)
func (_Coin *CoinSession) RoleManager() (common.Address, error) {
	return _Coin.Contract.RoleManager(&_Coin.CallOpts)
}

// RoleManager is a free data retrieval call binding the contract method 0x00435da5.
//
// Solidity: function roleManager() view returns(address)
func (_Coin *CoinCallerSession) RoleManager() (common.Address, error) {
	return _Coin.Contract.RoleManager(&_Coin.CallOpts)
}

// SetterRole is a free data retrieval call binding the contract method 0xc92fb947.
//
// Solidity: function setterRole() view returns(bytes32)
func (_Coin *CoinCaller) SetterRole(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "setterRole")
...
//
// Solidity: function setterRole() view returns(bytes32)
func (_Coin *CoinSession) SetterRole() ([32]byte, error) {
	return _Coin.Contract.SetterRole(&_Coin.CallOpts)
}

// SetterRole is a free data retrieval call binding the contract method 0xc92fb947.
//
// Solidity: function setterRole() view returns(bytes32)
func (_Coin *CoinCallerSession) SetterRole() ([32]byte, error) {
	return _Coin.Contract.SetterRole(&_Coin.CallOpts)
}
...
// ValidatorRole is a free data retrieval call binding the contract method 0x42f7022e.
//
// Solidity: function validatorRole() view returns(bytes32)
func (_Coin *CoinCaller) ValidatorRole(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Coin.contract.Call(opts, &out, "validatorRole")
...
//
// Solidity: function validatorRole() view returns(bytes32)
func (_Coin *CoinSession) ValidatorRole() ([32]byte, error) {
	return _Coin.Contract.ValidatorRole(&_Coin.CallOpts)
}

// ValidatorRole is a free data retrieval call binding the contract method 0x42f7022e.
//
// Solidity: function validatorRole() view returns(bytes32)
func (_Coin *CoinCallerSession) ValidatorRole() ([32]byte, error) {
	return _Coin.Contract.ValidatorRole(&_Coin.CallOpts)
}
...
// PermitWithSignature is a paid mutator transaction binding the contract method 0xc39a717a.
//
// Solidity: function permitWithSignature(address owner, address spender, uint256 value, uint256 deadline, bytes signature) returns()
func (_Coin *CoinTransactor) PermitWithSignature(opts *bind.TransactOpts, owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Coin.contract.Transact(opts, "permitWithSignature", owner, spender, value, deadline, signature)
}

// PermitWithSignature is a paid mutator transaction binding the contract method 0xc39a717a.
//
// Solidity: function permitWithSignature(address owner, address spender, uint256 value, uint256 deadline, bytes signature) returns()
func (_Coin *CoinSession) PermitWithSignature(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Coin.Contract.PermitWithSignature(&_Coin.TransactOpts, owner, spender, value, deadline, signature)
}

// PermitWithSignature is a paid mutator transaction binding the contract method 0xc39a717a.
//
// Solidity: function permitWithSignature(address owner, address spender, uint256 value, uint256 deadline, bytes signature) returns()
func (_Coin *CoinTransactorSession) PermitWithSignature(owner common.Address, spender common.Address, value *big.Int, deadline *big.Int, signature []byte) (*types.Transaction, error) {
	return _Coin.Contract.PermitWithSignature(&_Coin.TransactOpts, owner, spender, value, deadline, signature)
}
...
func (_Coin *CoinTransactor) SetRoleManager(opts *bind.TransactOpts, _roleManager common.Address) (*types.Transaction, error) {
	return _Coin.contract.Transact(opts, "setRoleManager", _roleManager)
}

// SetRoleManager is a paid mutator transaction binding the contract method 0xf1d588c5.
//
// Solidity: function setRoleManager(address _roleManager) returns()
func (_Coin *CoinSession) SetRoleManager(_roleManager common.Address) (*types.Transaction, error) {
	return _Coin.Contract.SetRoleManager(&_Coin.TransactOpts, _roleManager)
}

// SetRoleManager is a paid mutator transaction binding the contract method 0xf1d588c5.
//
// Solidity: function setRoleManager(address _roleManager) returns()
func (_Coin *CoinTransactorSession) SetRoleManager(_roleManager common.Address) (*types.Transaction, error) {
	return _Coin.Contract.SetRoleManager(&_Coin.TransactOpts, _roleManager)
}
...
// CoinEIP712DomainChangedIterator is returned from FilterEIP712DomainChanged and is used to iterate over the raw logs and unpacked data for EIP712DomainChanged events raised by the Coin contract.
type CoinEIP712DomainChangedIterator struct {
	Event *CoinEIP712DomainChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *CoinEIP712DomainChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(CoinEIP712DomainChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *CoinEIP712DomainChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *CoinEIP712DomainChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// CoinEIP712DomainChanged represents a EIP712DomainChanged event raised by the Coin contract.
type CoinEIP712DomainChanged struct {
	Raw types.Log // Blockchain specific contextual infos
}
...
func (_Coin *CoinFilterer) FilterEIP712DomainChanged(opts *bind.FilterOpts) (*CoinEIP712DomainChangedIterator, error) {

	logs, sub, err := _Coin.contract.FilterLogs(opts, "EIP712DomainChanged")
	if err != nil {
		return nil, err
	}
	return &CoinEIP712DomainChangedIterator{contract: _Coin.contract, event: "EIP712DomainChanged", logs: logs, sub: sub}, nil
}

// WatchEIP712DomainChanged is a free log subscription operation binding the contract event 0x0a6387c9ea3628b88a633bb4f3b151770f70085117a15f9bf3787cda53f13d31.
//
// Solidity: event EIP712DomainChanged()
func (_Coin *CoinFilterer) WatchEIP712DomainChanged(opts *bind.WatchOpts, sink chan<- *CoinEIP712DomainChanged) (event.Subscription, error) {

	logs, sub, err := _Coin.contract.WatchLogs(opts, "EIP712DomainChanged")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(CoinEIP712DomainChanged)
				if err := _Coin.contract.UnpackLog(event, "EIP712DomainChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event EIP712DomainChanged()
func (_Coin *CoinFilterer) ParseEIP712DomainChanged(log types.Log) (*CoinEIP712DomainChanged, error) {
	event := new(CoinEIP712DomainChanged)
	if err := _Coin.contract.UnpackLog(event, "EIP712DomainChanged", log); err != nil {
		return nil, err
	}
